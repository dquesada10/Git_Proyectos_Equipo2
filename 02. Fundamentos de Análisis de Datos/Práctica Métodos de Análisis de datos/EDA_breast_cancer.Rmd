...
Viendo estas gráficas vemos que existe un gran solapamiento entre las variables, por lo tanto, no existe correlación entre ellas en general. De forma clara, únicamente se observa como a menores meses de supervivencia hay mas fallecidas.
